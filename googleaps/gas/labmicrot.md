...
# Створення розподіленого застосунку з використанням GAS, Mikrotik та месенжерів: практична частина 
...
![image-20221206172807635](media/image-20221206172807635.png)
...
![image-20221206182744389](media/image-20221206182744389.png)

рис.4.4. Відображення запису 

- [ ] Запустіть ще кілька разів скрипт, щоб створилося кілька записів в таблиці.
...
![image-20221206223810030](media/image-20221206223810030.png) 
...
Для тестування API можна скористатися різними безкоштовними утилітами. У даній лабораторній роботі пропонується скористатися доповненням до браузерів `FireFox` з назвою  RESTED.

- [ ] Встановіть розширення для браузера RESTED, або аналогічне, яке можна знайти за посиланнями https://addons.mozilla.org/en-US/firefox/addon/rested/
- [ ] Скопіюйте в буфер URL для тестування (закінчується на `\dev`). Вставте в якийсь текстовий файл.

![image-20221206225524279](media/image-20221206225524279.png)
...
![image-20221206232645522](media/image-20221206232645522.png)
...
![image-20221206233321195](media/image-20221206233321195.png)
...
![image-20221207125150736](media/image-20221207125150736.png)
...
![image-20221207130922173](media/image-20221207130922173.png)
...
![image-20221207151140977](media/image-20221207151140977.png)
...
![image-20221207153148624](media/image-20221207153148624.png)
...
![image-20221207165856214](media/image-20221207165856214.png)
...
![image-20221207171108517](media/image-20221207171108517.png)
...
![image-20221208104533416](media/image-20221208104533416.png)
...
![image-20221208145959795](media/image-20221208145959795.png)
...
![image-20221208151349365](media/image-20221208151349365.png)
