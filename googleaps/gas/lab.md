...
# REST API на Google Apps Scripts: практична частина
...
рис.1. Створення таблиці Google Sheet
...
рис.2. Створення розширення на Apps Script
...
![image-20221206182104694](media/image-20221206182104694_1.png)

рис.3. Дозвіл на доступ застосунку до Google Sheet
...
- [ ] Збережіть проект
- [ ] Опублікуйте скрипт як Веб-застосунок (рис.5). 

![image-20221206223810030](media/image-20221206223810030.png) 

рис.5. Публікація скрипту як Веб-застосунку 
...
рис.6. Отримання посилання на інтерфейс режиму розроблення
...
рис.7. Перевірка роботи запиту GET для доступу до переліку листів.
...
рис.8. Перегляд журналу виконання
...
рис.9. Перегляд методу POST за допомогою RESTED 
...
рис.10. Публікація нової версії застосунку
