...
рис.1. Налаштування MQTT Explorer
...
- [ ] Перейдіть на <http://vps-ca0b07b2.vps.ovh.net:1880/ui/> (надалі, **тестовий сервер**) виберіть вкладку і групу елементів **з вашим варіантом**.
...
- круговий індикатор температури 
 ...
 ![рис.2. Вибір вкладки з варіантом та панель для варіанту ](media/Рисунок2.png)
...
- [ ] На тестовому сервері (<http://vps-ca0b07b2.vps.ovh.net:1880/ui/>) змініть якісь значення повзунків
...
![рис.5. Налаштування отримання даних по MQTT.](media/Рисунок5.png) 

рис.5. Налаштування брокеру в MQTT
...
![рис.6. Вигляд фрагменту програми Node-RED та локального інтерфейсу.](media/Рисунок6.png) 

рис.6. Фрагмент програми в Node-RED для роботи з MQTT
...
![рис.7. Вигляд фрагменту програми Node-RED для формування синусоїди.](media/Рисунок7.png)  

рис.7. Фрагмент програми для генерування синусоїди
...
![](media/testclient.png)

рис.8. Реалізація "коротко-замкнутого" з'єднання видавця і абонента в Node-RED
...
Для виконання даної частини практичного завдання необхідно мати пристрій з Android або iOS. Даний пристрій буде використовуватися як мобільний клієнт MQTT. 
