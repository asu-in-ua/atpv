...
**Даний пункт не є обов'язковим для виконання, якщо Ви плануєте встановлювати EcoStruxure Machine Expert на рідну хостову ОС, або якщо у Вас вже є встановлена ВМ з сучасною OS Windows. Однак при відсутності ліцензії на EcoStruxure Machine Expert, використання віртуальної машини дасть можливість пізніше повторно інсталювати ПЗ на новий екземпляр віртуальної машини.**  
...
Для ознайомлення з EcoStruxure Machine Expert та навчальних цілей передбачена trial-ліцензія. Вона має часові обмеження (для версії 2.3 - це 42 дня). 
...
- [ ] У межах папки `LabIntro` розмістіть файл проєкту.
- [ ] У межах папки `LabIntro` створіть Google документ з копіями екрану та іншими матеріалами, якщо такі потребуються.  
