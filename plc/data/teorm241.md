...
![image-20260206164654407](mediam241/image-20260206164654407.png)
...
- VAR_STAT - статичні змінні (static variables) ведуть себе подібно до VAR в функціональних блоках, за винятком того що вони спільні для всіх екземплярів. Тобто зміна значення в будь якому екземплярі приводить до зміни в усіх інших. Їх можна застосовувати, наприклад, у функціональному блоці як лічильник кількості викликів. Вони доступні у функціональних блоках, методах і функціях.  
