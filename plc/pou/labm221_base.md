...
# Робота з функціональними блоками в EcoStruxure Machine Expert Basic: практична частина 
...
Практичне заняття розробив Дмитро Мацебула [АКТСУ НУХТ](http://www.iasu-nuft.pp.ua)
