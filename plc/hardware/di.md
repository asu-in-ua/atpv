...
рис.5 Приклад 2-х провідного підключення  індуктивного датчика наближення до входу типу source (- на вході DI PLC) (анімацію взято [звідси](https://controlbyte.tech/blog/sinking-vs-sourcing-understanding-plc-input-and-output-sensors/))
