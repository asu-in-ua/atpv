...
### 12. Отримання індивідуального завдання для програми користувача.
...
### 13. Формування переліку входів/виходів. 
...
### 15. Розробка методики перевірки.

- [ ] Розробіть методику перевірки, аналогічно, як це зроблено в п.5.7. 

### 16. Розробка та перевірка програми користувача.
