...
- [ ] Ознайомтеся з основними теоретичними відомостями з [Основи віртуалізації з використанням Virtual Box](teor.md)
...
- [ ] Якщо Ви не плануєте використовувати ВМ `Windows10` у майбутньому, вилучіть і її.
