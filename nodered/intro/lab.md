...
- [ ] Відкрийте папку розміщення програми Node-RED там мають бути два файли:

- `flows.json` - файл програми користувача
- `flows_cred.json` - файл з налаштуваннями облікових даних 
...
5. Розкажіть про структуру об'єкта msg.
6. Розкажіть про призначення вузла switch.
7. Розкажіть про роботу вузлів "node-red-contrib-os".
8. Яким чином робиться експорт і імпорт фрагментів програми Node-RED?
9. Як можна запустити Node-RED з "чистого аркушу" не видаляючи вузли вручну?
