...
Наприклад, в СКБД mariadb можна запустити однойменну програму (рис.2), ввести ім'я користувача та пароль доступу до СКБД, та зайти у меню введення SQL команд. На ис.2 показаний приклад виведення списку баз даних та усіх записів з таблиці testdb. 

![](media/2.png)

рис.2. Робота з консоллю
...
На рис.3 показаний приклад перевірки SQL-запиту в інший безкоштовній утиліті HeidiSQL, яка ставиться разом з  MariaDB.

![](media/3.png)

рис.3. Тестова утиліта для робота з СКБД
...
Основні команди SQL відповідно до цих груп наведені на рис.4.

![](media/4.png)

рис.4. Класифікація команд за призначенням
...
Колонка типу даних (datatype) означує які значення в полі : integer, character, money, date and time, binary і т.п. Для різних типів БД типи можуть відрізнятися. У таблицях 1-3 показані для прикладу типи даних для MySQL. 

Таблиця 1. Деякі текстові типи даних MySQL
...
Таблиця 2. Деякі числові типи даних MySQL
...
Таблиця 2. Типи даних дати та часу в MySQL
...
## 4. Запити для створення та модифікації даних
...
виведе записи у вигляді, як на рис.6. Зверніть увагу, на назви колонок.

![](media/6.png)

рис.6. Виведення назви колонок через псевдоніми.
