...
- 1 [Машинне навчання](1__Machine_Learning.md)
  - 1.1 [Навчання на основі даних](1_1_Learning_from_data.md)
  - 1.2 [Регресія на основі базисних функцій](1_2_Basis_function_regression.md)
  - 1.3 [Недостатнє навчання та перенавчання](1_3_Under_and_overfitting.md)
  - 1.4 [Категорії моделей ](1_4_Categories_of_models.md)
- 2 [Ефективне обчислення](2__Efficient_computation.md)
  - 2.1 [Графічні процесори (GPU), TPU та пакети](2_1_GPUs_TPUs_and_batches.md)
  - 2.2 [Тензори](2_2_Tensors.md)
- 3 [Тренування](3__Training.md)
