...
- [ ] У локальному репозиторії змініть один з рядків у файлі `README.md` та виконайте `Commit` з коментарем `Зміни в локальному репозиторії`, не виконуючи `push`.
- [ ] Через веб-інтерфейс GitHub внесіть інші зміни в цей самий файл `README.md` у тому самому рядку та зафіксуйте їх комітом з коментарем `Зміни на GitHub`.
...
4. Чим відрізняється `fetch` від `pull`?
...
11. Які способи мережної взаємодії між Git і GitHub були застосовані в лабораторній роботі? Як відбувається їх налаштування? 
