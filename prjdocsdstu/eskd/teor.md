...
Таблиця 4.1. Літерні коди видів елементів
...
У схемах постійного струму вхідні та вихідні ділянки позначають із зазначенням полярності: плюс `L+`, мінус `L-`, як або просто `+` та `-`, середній провідник позначають буквою `М`. Ділянки позитивної полярності нумерують непарними, а негативної полярності – парними числами. Якщо в процесі роботи схеми ділянка змінює полярність, то ділянки, що не мають явно вираженої полярності (провідник, що з'єднує дві послідовно з'єднані котушки, резистори тощо), позначаються парними чи непарними числами. У схемах однофазного змінного струму (фаза-нейтраль, фаза-фаза) ділянки кіл позначають аналогічно колам постійного струму з додаванням індексу фази `А`, `В`, `С` або (IV). Індекс фази чи нейтралі пишуть перед цифровою частиною. Парні (непарні) числа можуть надаватися будь-яким ділянкам кола будь-якої фази або нейтралі (нулю). У схемах трифазного змінного струму ділянки кіл позначають без поділу на парні та непарні з додаванням перед цифровою частиною індексу фази.
