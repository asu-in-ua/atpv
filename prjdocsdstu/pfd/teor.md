...
# Технологічних схеми: теоретична частина
...
Хоч для схем PFD не вказують деталізацію щодо КВПіА, деякі стандарти передбачають їх ідентифікацію вже на цих схемах. Для цього в нижній частині кружка може бути вказано позиційне позначення, яке посилається на ідентифікатор приладу де реалізована дана функція.
