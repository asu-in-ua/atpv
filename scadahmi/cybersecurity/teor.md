...
## 1. Актуальність питання кібербезпеки в АСКТП 
...
## 2. Основні загрози та напрями кібератак у системах АСКТП 
...
## 3. Основні вразливості в системах АСКТП 
...
<a href="media9/9_39.png" target="_blank"><img src="media/1.png"/></a> 

*Рис. 9.39.* Приклад поверхні атаки інтегрованої автоматизованої системи керування підприємства

## 4. Методи та засоби кібербезпеки АСКТП

Для кіберзахисту використовують ряд заходів, які розглянуті в параграфі 5. Ті, в свою чергу, базуються на методах та засобах, що використовуються для кібербезпеки. Розглянемо деякі з них.   
...
## 5. Заходи для кіберзахисту в АСКТП  
...
<a href="media9/9_40.png" target="_blank"><img src="media/9_40.png"/></a> 
...
## 6. Захист даних з використанням криптографії
...
<a href="media9/9_42.png" target="_blank"><img src="media/9_42.png"/></a> 
...
## 7. Віддалений доступ та використання VPN
...
<a href="media9/9_43.png" target="_blank"><img src="media/9_43.png"/></a> 
...
<a href="media9/9_44.png" target="_blank"><img src="media/9_44.png"/></a> 
