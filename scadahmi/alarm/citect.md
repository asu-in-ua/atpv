...
<a href="media/6_14.png" target="_blank"><img src="media/6_14.png"/></a>           

*Рис. 6.14*. Приклад налаштування тривог у Citect (вказані вибіркові поля).

Для означення поведінки тривоги на дисплеях (сторінках) тривоги класифікуються через категорії (див. параграф 3). Тривоги створюються відповідно до вибраного типу. 
...
*Таблиця 6.7.* **Типи тривог у** **SCADA Citect**
...
<a href="media/6_16.png" target="_blank"><img src="media/6_16.png"/></a> 

*Рис. 6.16.* Приклад додаткових налаштувань аналогової тривоги

## 3. Категорія тривог (Alarm Category) 
...
## 4. Ведення журналів тривог і подій та їх відображення на дисплеях (сторінках)  
...
Журнал зведення тривог (Alarm summary log) зберігається в пам’яті і з певною періодичністю або за подією записується на диск у папку, що вказана параметром `[DATA]`. За замовчуванням це проводиться автоматично, і сторінки зведення можуть показувати зміст журналу. Якщо необхідно зведення тривог переглядати в інших програмах, його можна виводити на пристрій системного виведення (див.6), наприклад, у текстовий файл або в базу даних. 

У старих версіях Citect журнал списку тривог (Alarm Log) був єдиним способом ведення історії тривог. Журнал був реалізований через пристрої системного виведення (див.6), який давав змогу виводити тривоги в базу даних, принтер або текстовий файл. Зараз стандартним підходом є використання SOE, тому журнал використовується радше для виведення для сторонніх програм або принтер.  
...
<a href="media/6_18.png" target="_blank"><img src="media/6_18.png"/></a> 
...
<a href="media/6_19.png" target="_blank"><img src="media/6_19.png"/></a> 

*Рис. 6.19.* Відтермінування тривог

<a href="media/6_20.png" target="_blank"><img src="media/6_20.png"/></a> 
...
<a href="media/6_23.png" target="_blank"><img src="media/6_23.png"/></a> 
...
<a href="media/6_24.png" target="_blank"><img src="media/6_24.png"/></a> 
...
## 5. Використання властивостей тривог як тегів  
...
## 6. Пристрої системного введення/виведення в Citect та ведення журналу користувацьких подій 
...
<a href="media/6_26.png" target="_blank"><img src="media/6_26.png"/></a> 
...
<a href="media/6_27.png" target="_blank"><img src="media/6_27.png"/></a> 
...
Для означення формату запису в файл використовуються спеціальні поля, як це робиться для полів тривог (див. 3). Якщо в тривогах не означений формат для журналу, то буде використовуватися той, який означений для пристрою. Для журналу дій оператора використовуються спеціальні імена полів, які вказані в табл. 6.12. 
...
<a href="media/6_28.png" target="_blank"><img src="media/6_28.png"/></a> 

*Рис. 6.28* Вказівка на пристрій для графічного елемента та системної клавіатурної команди 

<a href="media/6_29.png" target="_blank"><img src="media/6_29.png"/></a> 
...
## 7. Додаткові функції тривог в Citect 
...
<a href="media/6_30.png" target="_blank"><img src="media/6_30.png"/></a> 

*Рис. 6.30.* Фрагмент дисплею що створений на базі шаблонів Situational Awareness. 

<a href="media/6_31.png" target="_blank"><img src="media/6_31.png"/></a> 

*Рис. 6.31.* Фрагмент дисплея активних тривог, створеного на базі шаблонів Situational Awareness 

<a href="media/6_32.png" target="_blank"><img src="media/6_32.png"/></a> 
