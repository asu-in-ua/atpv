...
При необхідності відображення тексту у форматованому вигляді не обов'язково користуватися спеціальними форматами, наприклад DOCX. Останні зберігають документи не в текстовому форматі, що ускладнює їх відображення в онлайні і керування версіями, як наприклад з Git чи GitHub/GitLab. Хоч DOCX по факту є архівним документом з певним текстовим змістом навіть для форматування, він є досить складним, хоч і досить функціональним.  Альтернативою цьому є більш проста мова форматування Markdown, яка дозволяє відображати форматовані тексти на сторінках та використовувати мультикористувацькі функції. Крім того,  Markdown використовується в багатьох інструментах, наприклад GitHub для відображення текстового змісту репозиторіїв, або Node-RED для представлення всього текстового наповнення в файлі потоку.    
...
## 2. Області використання MarkDown
...
## 4. Базовий синтаксис MarkDown (MD) 
...
## 7. Створення діаграм з використанням Mermaid
