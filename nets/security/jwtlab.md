...
### 6. Тестування використання на сервісах Google  

Використання JWT можна перевірити для сервісів Google в [Автентифікація в Google Workspace : практична частина](../../googleaps/googleauth/lab.md)
