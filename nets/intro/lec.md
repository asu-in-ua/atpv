...
## 1. Комп'ютерні мережі та розподілені системи
...
## 2. Використання комп'ютерних мереж
...
## 3. Мережне апаратне забезпечення
...
Мережа утворюється комбінацією підмережі та її хостів. Однак слово «мережа» часто вживається також у вільному значенні. Підмережу можна описати як мережу, як у випадку «мережі ISP» на рис.10. Інтермережа може також бути описана як a мережа, як в WAN на рис. 8. 
...
## 4. Ієрархія протоколів в мережах
