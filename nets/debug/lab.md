...
- [ ] Завантажте образ Debian і створіть віртуальну машину з Debian, порядок встановлення описано в [Встановлення ВМ з Debian: практичне заняття](../../vm/vbox/labdebian.md), використовуйте Варіант 2 (самостійне встановлення)
