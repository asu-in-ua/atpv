...
# Базове налаштування маршрутизатору: практична частина (WinXP)
...
- [ ] Встановіть віртуальну машину ОС маршрутизатору Mikrotik, якщо його ще не встановлено, як описано в цьому [практичному занятті](../../vm/vbox/labmicrot.md)  
