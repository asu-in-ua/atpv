...
# Основи Ethernet та IP (VMXP)

Дане практичне заняття передбачає використання віртуальної машини Windows XP. Якщо на вашому хостовому ПК достатньо ресурсів для роботи з віртуальними машинами  Windows 10, рекомендується виконувати практичне заняття з використанням VM Windows 10 за [цим посиланням](labwin10.md). 
