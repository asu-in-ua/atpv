...
Рис.18. Сумісність між FDT2 і FDT 1.x
...
рис.20. Клієнт-серверна архітектура FDT2
...
рис.21. Відображення DTM пристрою Ethernet/IP у об’єктній моделі OPC UA

![image-20260330011139720](media/image-20260330011139720.png)

рис.22. Приклад внутрішньої реалізації відображення
...
рис.24. Використання HTML5 для WebUI 
