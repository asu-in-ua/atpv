...
Industrial Ethernet Manager добалвяється як сервіс до порта Ethernet (рис.4), в межах якого конфігурується обмін з різноманітними пристроями, які добавляються в мережу. 

![image-20260203155600696](../../plc/hardware/mediam241/image-20260203155600696.png)

![image-20260203160336455](../../plc/hardware/mediam241/image-20260203160336455.png)

![image-20260203161223506](../../plc/hardware/mediam241/image-20260203161223506.png)

рис.4.

Налаштування обміну з використанням Industrial Ethernet Manager розглядаються в  [Конфігурування локальної та розподіленої системи I/O M241 в Machine Expert : практична частина](../../plc/hardware/lab_m241.md). Тут розгялнемо загальні принципи роботи сканерів.

Керування виконується за допомогою стабільного та циклічного обміну даними (служба scanner), які доступні для таких протоколів:

- EtherNet/IP 
- Modbus TCP
- Sercos (для деяких контролерів, наприклад M262) 

Контролер виконує роль центрального вузла мережі, який циклічно обмінюється даними з веденими пристроями, які в термінології такого обміну позначаються як slave. Цей обмін організований у вигляді періодичного опитування.
...
| DTM                       | Для пристроїв, що підтримують DTM: технологія FDT/DTM дозволяє конфігурувати мережні пристрої в EcoStruxure Machine Expert. |
| Libraries                 | Функції / функціональні блоки (призначені для пристрою), доступні для використання прикладною програмою. |
| Predefined connections    | Використовуються для налаштування циклічного обміну даними. Потрібно вибрати одне із запропонованих з’єднань, яке містить необхідну інформацію. |
