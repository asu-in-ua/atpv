...
- [Типи сигналів та подання інформації в системах керування](signals/README.md)
...
- [Керування переміщенням](motion/README.md)
...
- Пошукові алгоритми
- [Паттерни та каркаси](pattern/README.md)
...
- [Електроніка для швидкого прототипування](electronproto/README.md)
...
- [Проектування комп'ютерно-інтегрованих систем керування](pkisc/README.md) 
...
- [Промисловий Інтернет речей (IIoT)](iiot/README.md)
- AR/VR
- IIoT Platforms
- 3D Printing
...
### Виконання документів та схем 

- [Формати документів](docs/README.md)
...
- [Загальні об'єкти автоматизації в галузях](generalob/README.md)
- Цукрове виробництво
- Молочне виробництво
- Кондитерське виробництво
- Оліє-екстракційне виробництво
- Транспортно-технологічні системи зернових і насіннєвих заводів
